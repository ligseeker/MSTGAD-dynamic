"""
MSTGAD on GAIA Dataset - 入口脚本
Usage:
    python main_GAIA.py
    python main_GAIA.py --epochs 2 --batch_size 5  # 快速测试
    python main_GAIA.py --max_timesteps 5000        # 只加载前5000个时步
    python main_GAIA.py --evaluate True --model_path ./result/xxx
"""

import util.util as util
import util.train as train
import util.GAIA.data_GAIA as data_loads
from util.GAIA.parser_GAIA import args
...
if __name__ == '__main__':
    ...
    # 直接传递args引用，让Process内部auto-detect后修改能反映到这里
    processed = data_loads.Process(args)

    # 打印auto-detect后的实际维度
    logging.info(f"Actual dimensions: raw_node={args['raw_node']}, log_len={args['log_len']}, raw_edge={args['raw_edge']}")
